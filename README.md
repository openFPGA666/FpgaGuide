...
《[数字电子技术基础](https://pan.baidu.com/s/1WrWbXFL1WaSFi74zcfpoOQ)》第5版 -- 阎石（提取码：8lyd）
### verilog HDL教程
...
![](https://github.com/openFPGA666/FpgaGuide/tree/main/img/fpga.jpg)

# 联系作者
作者是一名普通的FPGA开发者，热爱学习和分享。
参加工作以后越来越理解交流和分享的重要性，在不停地汲取营养的同时，也希望能帮助到更多的小伙伴们。
![](https://github.com/openFPGA666/FpgaGuide/tree/main/img/wetcat.jpg)
